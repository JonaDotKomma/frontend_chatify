...
function EditClient({ user, onLogout, }) {
    ...
    async function updateClient(data) {
        ...
        try {
            const response = await axios.post('/editarUsuarioOdoo', payload);
    ...
    async function createClient(data) {
        ...
        try {
            const response = await axios.post('/crearUsuario', payload);
    ...
    const clienteodbynumber = async (data) => {
        ...
        if (!data.id_odoo) { // Verifica si data.id_odoo es null, undefined, '', 0, o cualquier valor falsy
            try {
                ...
                const response = await axios.post('/getInfoUserOdooForNumber', postData);
